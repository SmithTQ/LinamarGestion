      ...
      peticiones: {
        eliminarDistritoLimaPorId: {
          completo: function (respuesta) {
            ...
            v && vistaListarDistritosLima.peticiones.listarDistritosLima();
          },
        },
        listarDistritosLima: {
          beforeSend: function () {
            ...
            if (datos && datos.length > 0) {
              ...
              $('#tablaListaDistritosLima').DataTable( {
                ...
                columnDefs: [
                  ...
                  {
                      render: (data, type, row) => "<div class=\"btn-group btn-group-sm float-end\"><button class=\"btn btn-dark\">X</button><button class=\"btn btn-dark\">+</button><button class=\"btn btn-dark\">X</button></div>",
                      targets: 5
                  }
              ]
              } );
