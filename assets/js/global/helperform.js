...
var HelperForm = {
    ...
    utils: {
        ...
        mergeObj: function (obj1, obj2) {
            for (var key in obj2) {
                if (obj2[key] instanceof File) {
                    obj1[key] = obj2[key]; // Solo asigna directamente
                } else if (typeof obj2[key] != "number" && typeof obj2[key] != "undefined" && obj2[key] != null && obj2[key].constructor() === "function") {
            ...
            fill: function (type, el, val) {
                ...
                switch (type) {
                    ...
                    case HForm.ELEMENT_TYPES.RADIO:
                        ...
                        break;
                    case HForm.ELEMENT_TYPES.FILE:
                        HForm.fillForm.utils.process.file(el, val);
                        break;
                    default:
                ...
                processElement: function (form, el) {
                    ...
                    switch (type) {
                        ...
                        case HForm.ELEMENT_TYPES.CHECKBOX:
                            ...
                            break;
                        case HForm.ELEMENT_TYPES.FILE:
                            HForm.getFormData.utils.process.file(el, elementName, entityName);
                            break;
                        default:
